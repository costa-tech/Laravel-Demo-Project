                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse($proposals as $proposal)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900">${{ number_format($proposal->amount, 2) }}</div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <a href="{{ route('proposals.show', $proposal->id) }}" class="text-indigo-600 hover:text-indigo-900 mr-2">View</a>
                                            <a href="{{ route('proposals.edit', $proposal->id) }}" class="text-blue-600 hover:text-blue-900 mr-2">Edit</a>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="px-6 py-4 text-center text-gray-500">No proposals found.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
